...
import { ActivatedRouteStub, ImageCardStub, MarkdownViewerStub, ImageDalStub, ArticleDalStub } from "src/app/testing";
...
describe("CommonComponent", () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [CommonComponent, ImageCardStub, MarkdownViewerStub],
      providers: [
